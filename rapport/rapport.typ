...
#align(center)[
  #block(width: 100%)[
    ...
    #v(0.6em)
    #text(size: 10pt, fill: luma(70))[Guillaume Vaudescal · 2026-08-29 · #link("https://github.com/Guilou001/18-inflation-fondamentale")[Guilou001/18-inflation-fondamentale]]
  ]
]
#v(1.2em)
